...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/original.png',img)
...
if per_white > 10:
	...
	cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/color_change.png',img)
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/means_shift_image.png',img)
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/contour_complete_leaf.png', neworiginal)
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/ROI.png', frame)
cv2.imshow('rectangle ROI', roi)
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/rectangle_ROI.png',roi)
img = roi
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/HLS.png',imghls)
imghls[np.where((imghls==[30,200,2]).all(axis=2))] = [0,200,0]
cv2.imshow('new HLS', imghls)
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/new_HLS.png',imghls)

#Only hue channel
huehls = imghls[:,:,0]
cv2.imshow('img_hue hls',huehls)
#ret, huehls = cv2.threshold(huehls,2,255,cv2.THRESH_BINARY)
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/img_hue_hls.png', huehls)

huehls[np.where(huehls==[0])] = [35]
cv2.imshow('img_hue with my mask',huehls)
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/img_hue_with_my_mask.png',huehls)


#Thresholding on hue image
ret, thresh = cv2.threshold(huehls,28,255,cv2.THRESH_BINARY_INV)
cv2.imshow('thresh', thresh)
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/thresh.png',thresh)
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/masked_out_img.png',mask)
...
for x in range(len(contours)):
	...
	cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/Contour_masked.png',originalroi)
...
cv2.imwrite('/home/hp/Documents/Master thesis/Automatic-leaf-infection-identifier/output/orig_last.png',original)
